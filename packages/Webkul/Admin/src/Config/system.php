...
return [
    ...
    [
        ...
        'fields' => [
            [
                'name'          => 'enabled',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.enabled',
                'type'          => 'boolean',
                'channel_based' => true,
                'locale_based'  => false,
            ], [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.section-title',
                'type'          => 'text',
                'channel_based' => true,
                'locale_based'  => true,
            ], [
                'name'          => 'image_1',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.image-1',
                'type'          => 'image',
                'channel_based' => true,
                'validation'    => 'mimes:bmp,jpeg,jpg,png,webp,svg',
            ], [
                'name'          => 'link_1',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.link-1',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'url',
            ], [
                'name'          => 'image_2',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.image-2',
                'type'          => 'image',
                'channel_based' => true,
                'validation'    => 'mimes:bmp,jpeg,jpg,png,webp,svg',
            ], [
                'name'          => 'link_2',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.link-2',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'url',
            ], [
                'name'          => 'image_3',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.image-3',
                'type'          => 'image',
                'channel_based' => true,
                'validation'    => 'mimes:bmp,jpeg,jpg,png,webp,svg',
            ], [
                'name'          => 'link_3',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.link-3',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'url',
            ], [
                'name'          => 'image_4',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.image-4',
                'type'          => 'image',
                'channel_based' => true,
                'validation'    => 'mimes:bmp,jpeg,jpg,png,webp,svg',
            ], [
                'name'          => 'link_4',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.link-4',
                'type'          => 'text',
                'channel_based' => true,
                'validation'    => 'url',
            ], [
                'name'          => 'image_5',
                'title'         => 'admin::app.configuration.index.general.design.instagram-gallery.image-5',
                'type'          => 'image',
                'channel_based' => true,
                'validation'    => 'mimes:bmp,jpeg,jpg,png,webp,svg',
            ], [

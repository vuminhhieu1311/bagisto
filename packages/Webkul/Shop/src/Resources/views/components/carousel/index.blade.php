...
<v-carousel :images="{{ json_encode($options['images'] ?? []) }}">
    <div class="overflow-hidden">
        <div class="shimmer aspect-[1820/900] max-h-screen w-screen"></div>
    </div>
</v-carousel>
            ...
            >
                ...
                >
                    <x-shop::media.images.lazy
                        class="aspect-[1820/900] max-h-full w-full max-w-full select-none transition-transform duration-300 ease-in-out"
                        ::lazy="false"
                        ::src="image.image"

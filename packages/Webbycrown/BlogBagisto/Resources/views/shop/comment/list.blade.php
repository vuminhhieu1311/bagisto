...
<div id="comment-{{ $comment['id'] }}" class="media">
    ...
    <div class="media-body">
        ...
        @if( $nested_comment_index < $maximum_nested_comment )
            ...
            <button class="btn btn-primary btn-lg btn-reply">{{ __('Reply') }}</button>
            <button class="btn btn-danger btn-lg btn-cancel-reply d-none" style="display: none;">{{ __('Cancel Reply') }}</button>

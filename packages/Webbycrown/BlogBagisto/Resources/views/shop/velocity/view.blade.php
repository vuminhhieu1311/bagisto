                        ...
                        <div class="container-right row no-margin col-12 no-padding">
                            ...
                            <div id="blog" class="container mt-5">
                                ...
                                <div id="comment-list" class="column-12 comment-part related-bolg-part">
                                    <div class="col-lg-12">
                                        <h1 class="mb-3 page-title">{{ __('Related Blog') }}</h1>
                                    </div>
                                            ...
                                            <div class="blog-post-box">
                                                <div class="card mb-5">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="post-meta">
                                                            <p>
                                                                {{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $related_blog->created_at)->format('M j, Y') }} {{ __('by') }}
                                                    ...
                                                    <div class="card-footer">
                                                        <a href="{{route('shop.article.view',[$related_blog->category->slug . '/' . $related_blog->slug])}}" class="text-uppercase btn-text-link">{{ __('xem thêm >') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="comment-list" class="column-12 comment-part">
                                    <div class="row flex flex-wrap grid-wrap">
                                        <div class="column-12">
                                            ...
                                            <h2>{{ __('Comments') }} ({{ $total_comments_cnt }})</h2>
                                            <div class="row flex flex-wrap grid-wrap">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group column-6">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" name="name" placeholder="{{ __('Your Name') }}" required="required" class="form-control" value="{{ ( isset($loggedIn_user_name) && !empty($loggedIn_user_name) && !is_null($loggedIn_user_name) ) ? $loggedIn_user_name : ''; }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group column-6">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="email" name="email" placeholder="{{ __('Your Email') }}" required="required" class="form-control" value="{{ ( isset($loggedIn_user_email) && !empty($loggedIn_user_email) && !is_null($loggedIn_user_email) ) ? $loggedIn_user_email : ''; }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <textarea name="comment" placeholder="{{ __('Your Comment') }}" required="required" rows="5" class="form-control"></textarea>
                                                                </div>
                                                                <div class="form-group text-right">
                                                                    <button type="submit" class="btn btn-primary btn-lg">{{ __('Comment') }}</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="column-12">
                                                    <div class="comment-not-allow-guest">
                                                        {{ __('You must be logged in to comment. Clik') }} <a href="{{ URL::to('/') }}/customer/login" target="_blank"> {{ __('here') }}</a> {{ __('to login.') }}
                                                    </div>
                                                </div>
                                            ...
                                            @else
                                            <div class="comment-not-allow">{{ __('Comments are turned off.') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
